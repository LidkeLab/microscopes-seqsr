...
handles.ButtonResetSCMOS = uicontrol('Parent', SCMOSControlPanel, ...
    ...
    'Callback', @resetSCMOS);
handles.ButtonCalibSCMOS = uicontrol('Parent', SCMOSControlPanel, ...
    'Style', 'pushbutton', 'String', 'calib sCMOS', ...
    'Position', TopButtonPosition + [0, -75, 0, 0], ...
    'Callback', @calibSCMOS);
...
% methods that we need.
    ...
    function calibSCMOS(~, ~)
        % Callback for the calibrate sCMOS button.
        
        % Ensure the object properties are set based on the GUI.
        gui2properties();
        
        % Update the status indicator for the GUI.
        obj.StatusString = 'Calibrating main sCMOS...';
        
        % Call the calibrate SCMOS method.
        obj.calibscmos();
